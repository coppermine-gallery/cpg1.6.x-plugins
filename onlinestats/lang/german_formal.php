...
$lang_plugin_onlinestats['config_install'] = 'Dieses Plugin verursacht zusätzliche Datenbankabfragen bei jedem Lauf und verbraucht daher zusätzliche Resourcen auf dem Server. Wenn Ihre Galerie bereits langsam läuft und Sie eine große Menge von Benutzern haben sollten Sie dieses Plugin nicht installiert.';
