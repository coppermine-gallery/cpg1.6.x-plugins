...
/*************************
  ...
  ********************************************
  ...
  $HeadURL: https://svn.code.sf.net/p/coppermine/code/trunk/cpg1.6.x/plugins/onlinestats/codebase.php $
  $Revision: 8825M $
**********************************************/
...
function online_configure() {
    global $lang_plugin_onlinestats, $CONFIG, $lang_common, $lang_pluginmgr_php, $lang_admin_php, $icon_array;
...
function online_cleanup($action) {
    global $lang_plugin_onlinestats, $CONFIG, $lang_common, $icon_array;
    $superCage = Inspekt::makeSuperCage();
    ...
    <form action="{$cleanup}" method="post">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="tableb">
                    {$lang_plugin_onlinestats['remove']}
                </td>
                <td class="tableb">
