...
function enl_doenlarge(enl_imgid)
{
  ...
  else if (enl_ani==7) setTimeout('enl_topleftglide("'+enl_imgid+'",1)' ,50);
  else if (enl_ani==8) setTimeout('enl_topleftglide("'+enl_imgid+'",2)' ,50);
...
function enl_shrink(enl_imgid)
{
  ...
  else if (enl_ani==6) setTimeout('enl_topleftglout("'+enl_imgid+'",0)' ,50);
  else if (enl_ani==7) setTimeout('enl_topleftglout("'+enl_imgid+'",1)' ,50);
  else if (enl_ani==8) setTimeout('enl_topleftglout("'+enl_imgid+'",2)' ,50);
...
function enl_calcfact(enl_facthelp)
{
  ...
  else if (enl_ani == 4  || enl_ani > 5) enl_factor = (Math.sin(1.5 * Math.PI + enl_facthelp * Math.PI) + 1)/2;
...
function enl_count(enl_imgid)
{
  ...
  var enl_randomizenumber = Math.round(9999*Math.random());
  var enl_randomizeit = (enl_geturl.indexOf("?") <0) ? "?enl_rndit="+enl_randomizenumber : "&enl_rndit="+enl_randomizenumber;
  enl_geturl += enl_randomizeit;
  try {
...
// glide from top / left
function enl_topleftglide(enl_imgid,enl_tl)
{
  enl_img = enl_geto(enl_imgid);
  enl_img.steps++;
  if (enl_img.steps >= enl_maxstep)
  ...
  else
  {
    ...
    var enl_factor = enl_calcfact(enl_img.steps/enl_maxstep);
    enl_tmpt = (enl_tl == 0 || enl_tl == 2) ? Math.round(0-enl_img.newh+(enl_img.newh+enl_img.newt)*enl_factor) : enl_img.newt;
    enl_tmpl = (enl_tl > 0) ? Math.round(0-enl_img.neww+(enl_img.neww+enl_img.newl)*enl_factor) : enl_img.newl;
    enl_setpos(enl_img,enl_tmpl,enl_tmpt,enl_img.neww,enl_img.newh);
    if (enl_opaglide) enl_setopa(enl_img, Math.round(enl_img.steps/enl_maxstep*100));
    setTimeout('enl_topleftglide("'+enl_imgid+'",'+enl_tl+')' ,enl_speed);
  }
}

// glide to top/left
function enl_topleftglout(enl_imgid,enl_tl)
{
  enl_img = enl_geto(enl_imgid);
  enl_mvcnt = 0;
  enl_img.steps++;
  ...
  {
    var enl_factor = enl_calcfact((enl_maxstep-enl_img.steps)/enl_maxstep);
    enl_tmpt = (enl_tl == 0 || enl_tl == 2) ? Math.round(0-enl_img.newh+(enl_img.newt+enl_img.newh)*enl_factor) : enl_img.newt;
    enl_tmpl = (enl_tl > 0) ? Math.round(0-enl_img.neww+(enl_img.newl+enl_img.neww)*enl_factor) : enl_img.newl;
    enl_setpos(enl_img,enl_tmpl,enl_tmpt,enl_img.neww,enl_img.newh);
    if (enl_opaglide) enl_setopa(enl_img, Math.round((enl_maxstep-enl_img.steps)/enl_maxstep*100));
    setTimeout('enl_topleftglout("'+enl_imgid+'",'+enl_tl+')' ,enl_speed);
  }
}
